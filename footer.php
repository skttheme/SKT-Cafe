...
<div class="container">
     <div class="copyright-txt"><?php bloginfo('name'); ?> <?php esc_html_e('Theme By ','skt-cafe');?> <a href="<?php echo esc_url('https://www.sktthemes.org/shop/free-coffeehouse-wordpress-theme/');?>" target="_blank">
